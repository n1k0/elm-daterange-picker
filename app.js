...
var waratuman$time_extra$Time$Extra$addMillis = function (m) {
	return A2(
		elm$core$Basics$composeR,
		elm$time$Time$posixToMillis,
		A2(
			elm$core$Basics$composeR,
			elm$core$Basics$add(m),
...
var allo_media$elm_daterange_picker$DateRangePicker$Helpers$startOfNextMonth = function (zone) {
	return A2(
		elm$core$Basics$composeR,
...
var allo_media$elm_daterange_picker$DateRangePicker$Range$endsAt = function (_n0) {
	var end = _n0.a.end;
	return end;
};
		...
		if (_n0.b.$ === 'Just') {
			if (_n0.a) {
				...
				return _Utils_Tuple2(
					A2(
						waratuman$time_extra$Time$Extra$startOfMonth,
						elm$time$Time$utc,
						allo_media$elm_daterange_picker$DateRangePicker$Range$beginsAt(range)),
					A2(
						allo_media$elm_daterange_picker$DateRangePicker$Helpers$startOfNextMonth,
						elm$time$Time$utc,
						allo_media$elm_daterange_picker$DateRangePicker$Range$beginsAt(range)));
			} else {
				var range = _n0.b.a;
				return _Utils_Tuple2(
					A2(
						allo_media$elm_daterange_picker$DateRangePicker$Helpers$startOfPreviousMonth,
						elm$time$Time$utc,
...
var allo_media$elm_daterange_picker$DateRangePicker$Step$Complete = function (a) {
	return {$: 'Complete', a: a};
};
var allo_media$elm_daterange_picker$DateRangePicker$Step$Initial = {$: 'Initial'};
...
var allo_media$elm_daterange_picker$DateRangePicker$Step$fromMaybe = A2(
	elm$core$Basics$composeR,
	elm$core$Maybe$map(allo_media$elm_daterange_picker$DateRangePicker$Step$Complete),
	elm$core$Maybe$withDefault(allo_media$elm_daterange_picker$DateRangePicker$Step$Initial));
var waratuman$time_extra$Time$Extra$epoch = elm$time$Time$millisToPosix(0);
var allo_media$elm_daterange_picker$DateRangePicker$init = F2(
	function (config, selected) {
		var _n0 = A3(allo_media$elm_daterange_picker$DateRangePicker$getCalendars, config, selected, waratuman$time_extra$Time$Extra$epoch);
		var leftCal = _n0.a;
		var rightCal = _n0.b;
		return allo_media$elm_daterange_picker$DateRangePicker$State(
			{
				config: config,
				current: selected,
				disabled: false,
				...
				opened: false,
				rightCal: rightCal,
				step: allo_media$elm_daterange_picker$DateRangePicker$Step$fromMaybe(selected),
				today: waratuman$time_extra$Time$Extra$epoch
			});
	});
var allo_media$elm_daterange_picker$DateRangePicker$setToday = F2(
	function (today, _n0) {
		var internal = _n0.a;
		var _n1 = A3(allo_media$elm_daterange_picker$DateRangePicker$getCalendars, internal.config, internal.current, today);
		var newLeftCal = _n1.a;
		var newRightCal = _n1.b;
		return allo_media$elm_daterange_picker$DateRangePicker$State(
			_Utils_update(
				internal,
				{leftCal: newLeftCal, rightCal: newRightCal, today: today}));
	});
		...
		return A2(
			...
			function (today) {
				return elm$core$Task$succeed(
					A2(
						allo_media$elm_daterange_picker$DateRangePicker$setToday,
						today,
						A2(allo_media$elm_daterange_picker$DateRangePicker$init, config, selected)));
			},
			elm$time$Time$now);
	});
...
var allo_media$elm_daterange_picker$Main$initFromConfig = F2(
	function (config, range) {
		var picker = A2(allo_media$elm_daterange_picker$DateRangePicker$init, config, range);
		return _Utils_Tuple2(
			{config: config, picker: picker},
			A2(allo_media$elm_daterange_picker$DateRangePicker$now, allo_media$elm_daterange_picker$Main$PickerChanged, picker));
	});
var allo_media$elm_daterange_picker$Main$init = function (_n0) {
	return A2(
		allo_media$elm_daterange_picker$Main$initFromConfig,
		allo_media$elm_daterange_picker$DateRangePicker$configure(
			function (_default) {
				return _Utils_update(
					_default,
					{allowFuture: false, noRangeCaption: 'Click me!'});
			}),
		elm$core$Maybe$Nothing);
};
...
var allo_media$elm_daterange_picker$DateRangePicker$Step$next = F2(
	function (picked, step) {
		switch (step.$) {
			case 'Begin':
				var begin = step.a;
				return _Utils_eq(picked, begin) ? allo_media$elm_daterange_picker$DateRangePicker$Step$Complete(
					A2(allo_media$elm_daterange_picker$DateRangePicker$Range$create, begin, begin)) : ((_Utils_cmp(
					...
					A2(allo_media$elm_daterange_picker$DateRangePicker$Range$create, begin, picked)) : allo_media$elm_daterange_picker$DateRangePicker$Step$Begin(picked));
			case 'Complete':
...
var allo_media$elm_daterange_picker$DateRangePicker$update = F2(
	function (msg, internal) {
		var leftCal = internal.leftCal;
		var rightCal = internal.rightCal;
		...
		switch (msg.$) {
			...
			case 'Clear':
				return _Utils_update(
					internal,
					{
						...
						opened: false,
						step: allo_media$elm_daterange_picker$DateRangePicker$Step$fromMaybe(elm$core$Maybe$Nothing)
					});
			case 'Close':
				return _Utils_update(
					internal,
					{
						opened: false,
						step: allo_media$elm_daterange_picker$DateRangePicker$Step$fromMaybe(internal.current)
					});
			case 'Hover':
				var posix = msg.a;
				return _Utils_update(
			...
			case 'Next':
				return _Utils_update(
					...
					{
						leftCal: rightCal,
						rightCal: A2(allo_media$elm_daterange_picker$DateRangePicker$Helpers$startOfNextMonth, elm$time$Time$utc, rightCal)
					});
			case 'NoOp':
				return internal;
			case 'Open':
			...
			case 'Pick':
				...
				return _Utils_update(
					internal,
					{
						step: A2(allo_media$elm_daterange_picker$DateRangePicker$Step$next, picked, step)
					});
			case 'Prev':
				return _Utils_update(
					internal,
					{
						leftCal: A2(allo_media$elm_daterange_picker$DateRangePicker$Helpers$startOfPreviousMonth, elm$time$Time$utc, leftCal),
						rightCal: leftCal
					});
			default:
				var dateRange = msg.a;
				...
				return _Utils_update(
					internal,
					{
						leftCal: newLeftCal,
						rightCal: newRightCal,
						step: allo_media$elm_daterange_picker$DateRangePicker$Step$fromMaybe(
							elm$core$Maybe$Just(dateRange))
					});
		}
	});
...
var allo_media$elm_daterange_picker$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'PickerChanged') {
			var state = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
			...
			return A2(
				allo_media$elm_daterange_picker$Main$initFromConfig,
				config,
				allo_media$elm_daterange_picker$DateRangePicker$getRange(model.picker));
		}
	});
...
var allo_media$elm_daterange_picker$DateRangePicker$Clear = {$: 'Clear'};
var allo_media$elm_daterange_picker$DateRangePicker$Hover = function (a) {
	return {$: 'Hover', a: a};
};
var allo_media$elm_daterange_picker$DateRangePicker$Next = {$: 'Next'};
var allo_media$elm_daterange_picker$DateRangePicker$NoOp = {$: 'NoOp'};
var allo_media$elm_daterange_picker$DateRangePicker$Pick = function (a) {
	return {$: 'Pick', a: a};
};
...
var allo_media$elm_daterange_picker$DateRangePicker$Step$toMaybe = function (step) {
	if (step.$ === 'Complete') {
		var dateRange = step.a;
		return elm$core$Maybe$Just(dateRange);
	} else {
		return elm$core$Maybe$Nothing;
	}
};
...
var allo_media$elm_daterange_picker$DateRangePicker$predefinedRangesView = F2(
	function (toMsg, internal) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('EDRPPresets__label', true),
								_Utils_Tuple2(
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('EDRPPresets')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('EDRPPresets__list')
						]),
					A2(
						elm$core$List$map,
						entry,
...
var allo_media$elm_daterange_picker$DateRangePicker$Calendar$inRangePath = F3(
	function (maybeHovered, begin, day) {
		if (maybeHovered.$ === 'Just') {
			var hovered = maybeHovered.a;
			return A2(
				allo_media$elm_daterange_picker$DateRangePicker$Range$between,
				day,
				A2(allo_media$elm_daterange_picker$DateRangePicker$Range$create, begin, hovered));
		} else {
			return false;
		}
	});
...
var allo_media$elm_daterange_picker$DateRangePicker$Helpers$int00 = A2(
	elm$core$Basics$composeR,
...
var allo_media$elm_daterange_picker$DateRangePicker$Helpers$formatDate = F2(
	function (zone, posix) {
		return A2(
			elm$core$String$join,
			'-',
			_List_fromArray(
				[
					...
					allo_media$elm_daterange_picker$DateRangePicker$Helpers$int00(
...
var allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay = F3(
	function (zone, a, b) {
		return _Utils_eq(
			A2(waratuman$time_extra$Time$Extra$toDateTuple, zone, a),
			A2(waratuman$time_extra$Time$Extra$toDateTuple, zone, b));
	});
...
var allo_media$elm_daterange_picker$DateRangePicker$Calendar$dayCell = F2(
	function (_n0, day) {
		var allowFuture = _n0.allowFuture;
		var hover = _n0.hover;
		...
		var base = {active: false, end: false, inPath: false, inRange: false, start: false};
		var _n1 = function () {
			switch (step.$) {
				case 'Initial':
					return base;
				case 'Begin':
					...
					return _Utils_update(
						base,
						{
							active: A3(allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay, elm$time$Time$utc, begin, day),
							inPath: A3(allo_media$elm_daterange_picker$DateRangePicker$Calendar$inRangePath, hovered, begin, day),
							start: A3(allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay, elm$time$Time$utc, begin, day)
						});
				default:
					var range = step.a;
					return _Utils_update(
						base,
						{
							active: A3(
								...
								elm$time$Time$utc,
								day,
								allo_media$elm_daterange_picker$DateRangePicker$Range$beginsAt(range)) || A3(
								allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay,
								elm$time$Time$utc,
								day,
								allo_media$elm_daterange_picker$DateRangePicker$Range$endsAt(range)),
								...
								day,
								allo_media$elm_daterange_picker$DateRangePicker$Range$endsAt(range)),
							inRange: A2(allo_media$elm_daterange_picker$DateRangePicker$Range$between, day, range),
							start: A3(
								allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay,
								elm$time$Time$utc,
								day,
		...
		var active = _n1.active;
		var start = _n1.start;
		var end = _n1.end;
		var inRange = _n1.inRange;
		var inPath = _n1.inPath;
		return A2(
			elm$html$Html$td,
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('EDRPCalendar__cell', true),
								_Utils_Tuple2(
								'EDRPCalendar__cell--today',
								A3(allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay, elm$time$Time$utc, day, today)),
								_Utils_Tuple2('EDRPCalendar__cell--active', active),
								_Utils_Tuple2('EDRPCalendar__cell--inRange', inRange || inPath),
								_Utils_Tuple2('EDRPCalendar__cell--start', start),
								_Utils_Tuple2('EDRPCalendar__cell--end', end),
								_Utils_Tuple2('EDRPCalendar__cell--disabled', disabled),
								_Utils_Tuple2(
								'EDRPCalendar__cell--off',
								!_Utils_eq(
									A2(elm$time$Time$toMonth, elm$time$Time$utc, target),
									A2(elm$time$Time$toMonth, elm$time$Time$utc, day)))
							])),
						elm$html$Html$Events$onMouseOver(
						hover(day)),
						elm$html$Html$Attributes$title(
						A2(allo_media$elm_daterange_picker$DateRangePicker$Helpers$formatDate, elm$time$Time$utc, day))
					]),
				(!disabled) ? _List_fromArray(
					...
					[
						elm$html$Html$Events$onClick(noOp)
					])),
			_List_fromArray(
				[
					elm$html$Html$text(
					elm$core$String$fromInt(
						A2(elm$time$Time$toDay, elm$time$Time$utc, day)))
				]));
	});
...
var allo_media$elm_daterange_picker$DateRangePicker$Calendar$fromPosix = F2(
	function (weeksStartOn, posix) {
		var base = A2(waratuman$time_extra$Time$Extra$startOfDay, elm$time$Time$utc, posix);
		return A2(
			elm$core$List$take,
			6,
			A2(
				...
				A2(
					...
					A2(
						...
						elm$core$Basics$neq(weeksStartOn)),
					A2(
						elm$core$List$map,
						function (v) {
							return A2(waratuman$time_extra$Time$Extra$addDays, v, base);
						},
...
var allo_media$elm_daterange_picker$DateRangePicker$Calendar$weekdayNames = F2(
	function (weekdayFormatter, weeksStartOn) {
		var week = _List_fromArray(
			[elm$time$Time$Sun, elm$time$Time$Mon, elm$time$Time$Tue, elm$time$Time$Wed, elm$time$Time$Thu, elm$time$Time$Fri, elm$time$Time$Sat]);
		var index = A2(
			elm$core$Maybe$withDefault,
			1,
			A2(elm_community$list_extra$List$Extra$elemIndex, weeksStartOn, week));
		return A2(
			elm$core$List$map,
			weekdayFormatter,
			A2(
				elm$core$List$take,
				elm$core$List$length(week),
				A2(
					elm$core$List$drop,
					index,
					A2(
						elm_community$list_extra$List$Extra$cycle,
						elm$core$List$length(week) * 2,
						week))));
	});
var allo_media$elm_daterange_picker$DateRangePicker$Helpers$shortMonth = F3(
	function (zone, monthFormatter, day) {
		return monthFormatter(
			A2(elm$time$Time$toMonth, zone, day)) + (' ' + elm$core$String$fromInt(
			A2(elm$time$Time$toYear, zone, day)));
	});
...
var allo_media$elm_daterange_picker$DateRangePicker$Calendar$view = function (config) {
	...
	var weeksStartOn = config.weeksStartOn;
	var weekdayFormatter = config.weekdayFormatter;
	var monthFormatter = config.monthFormatter;
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('EDRPCalendar')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('EDRPCalendar__table')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('EDRPCalendar__head')
									]),
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('EDRPCalendar__month'),
								...
								A2(
									...
									A2(allo_media$elm_daterange_picker$DateRangePicker$Calendar$weekdayNames, weekdayFormatter, weeksStartOn)))
							])),
						A2(
						elm$html$Html$tbody,
						_List_Nil,
						A2(
							...
							A2(
								elm$core$Basics$composeR,
								elm$core$List$map(
									allo_media$elm_daterange_picker$DateRangePicker$Calendar$dayCell(config)),
								elm$html$Html$tr(_List_Nil)),
							A2(allo_media$elm_daterange_picker$DateRangePicker$Calendar$fromPosix, weeksStartOn, target)))
					]))
			]));
};
...
var allo_media$elm_daterange_picker$DateRangePicker$panel = F2(
	function (toMsg, _n0) {
		...
		var allowNext = internal.config.allowFuture || (_Utils_cmp(
			elm$time$Time$posixToMillis(
				A2(waratuman$time_extra$Time$Extra$startOfMonth, elm$time$Time$utc, internal.rightCal)),
			elm$time$Time$posixToMillis(
				A2(waratuman$time_extra$Time$Extra$startOfMonth, elm$time$Time$utc, internal.today))) < 0);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('EDRPFoot')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									function () {
									var _n1 = internal.step;
									switch (_n1.$) {
										case 'Initial':
											return elm$html$Html$text('Hint: pick a start date');
										case 'Begin':
											return elm$html$Html$text('Hint: pick an end date');
										default:
											var range = _n1.a;
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('EDRPFoot__actions')
								]),
							_List_fromArray(
								[
									(!internal.config.sticky) ? A2(
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('EDRP__button EDRP__button--primary'),
											elm$html$Html$Attributes$type_('button'),
											elm$html$Html$Events$onClick(
											A3(
												allo_media$elm_daterange_picker$DateRangePicker$handleEvent,
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Attributes$class(
							elm$core$String$trim('EDRP__input ' + internal.config.inputClass)),
							elm$html$Html$Attributes$disabled(internal.disabled),
							elm$html$Html$Attributes$value(
							A2(
								elm$core$Maybe$withDefault,
								internal.config.noRangeCaption,
								A2(
									elm$core$Maybe$map,
...
var allo_media$elm_daterange_picker$Main$dayFromString = function (string) {
	switch (string) {
		case 'Sunday':
			return elm$time$Time$Sun;
		case 'Monday':
...
var allo_media$elm_daterange_picker$Main$dayToString = function (day) {
	switch (day.$) {
		case 'Sun':
			return 'Sunday';
		case 'Mon':
...
var allo_media$elm_daterange_picker$Main$view = function (_n0) {
	...
	var field = function (children) {
		return A2(
			...
			_List_fromArray(
				[
					A2(elm$html$Html$label, _List_Nil, children)
				]));
	};
	return A2(
		elm$html$Html$div,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('elm-daterange-picker')
					])),
				A2(allo_media$elm_daterange_picker$DateRangePicker$view, allo_media$elm_daterange_picker$Main$PickerChanged, picker),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										function (allow) {
											return allo_media$elm_daterange_picker$Main$UpdateConfig(
												_Utils_update(
													config,
													{allowFuture: allow}));
										}),
										elm$html$Html$Attributes$checked(config.allowFuture)
									]),
								_List_Nil),
								elm$html$Html$text(' Allow future')
							])),
						field(
						_List_fromArray(
							[
									...
									[
										...
										function (allow) {
											return allo_media$elm_daterange_picker$Main$UpdateConfig(
												_Utils_update(
													config,
													{applyRangeImmediately: allow}));
										}),
										elm$html$Html$Attributes$checked(config.applyRangeImmediately)
									]),
								_List_Nil),
								elm$html$Html$text(' Apply predefined range immediately')
							])),
						field(
						_List_fromArray(
							[
								elm$html$Html$text('No range caption '),
								A2(
								elm$html$Html$input,
								_List_fromArray(
									[
										...
										function (caption) {
											return allo_media$elm_daterange_picker$Main$UpdateConfig(
												_Utils_update(
													config,
													{noRangeCaption: caption}));
										}),
										elm$html$Html$Attributes$value(config.noRangeCaption)
									]),
								_List_Nil)
							])),
						field(
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$checked(config.sticky)
									]),
								_List_Nil),
								elm$html$Html$text(' Sticky (always opened)')
							])),
						field(
						_List_fromArray(
							[
								elm$html$Html$text('Weeks start on '),
								A2(
										...
										function (str) {
											return allo_media$elm_daterange_picker$Main$UpdateConfig(
												_Utils_update(
													config,
													{
														weeksStartOn: allo_media$elm_daterange_picker$Main$dayFromString(str)
													}));
										})
									]),
								A2(
									...
									function (day) {
										return A2(
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$value(
													allo_media$elm_daterange_picker$Main$dayToString(day)),
													elm$html$Html$Attributes$selected(
													_Utils_eq(day, config.weeksStartOn))
												]),
											_List_fromArray(
												[
													elm$html$Html$text(
									...
									_List_fromArray(
										[elm$time$Time$Sat, elm$time$Time$Sun, elm$time$Time$Mon])))
							]))
					]))
			]));
};
var elm$browser$Browser$element = _Browser_element;
var allo_media$elm_daterange_picker$Main$main = elm$browser$Browser$element(
	{init: allo_media$elm_daterange_picker$Main$init, subscriptions: allo_media$elm_daterange_picker$Main$subscriptions, update: allo_media$elm_daterange_picker$Main$update, view: allo_media$elm_daterange_picker$Main$view});
_Platform_export({'Main':{'init':allo_media$elm_daterange_picker$Main$main(
